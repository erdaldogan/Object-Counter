...
**All of the images, quoted sentences and materials (excluding ```.gif```'s and ```output.csv```) used in README.md are from the slides of [Prof. Dr. Muhittin Gokmen](https://www.muhittingokmen.com)** 
